...
//  val aThr = new Thread( new Runnable {
//    override def run(): Unit = print("Dajeeee")
//  })
  ...
  val aThread = new Thread(() => println("I'm running in parallel")) // emoty lambda
  println("Im in main Thread !!!")
  aThread.start()
  aThread.join()
  ...
  println ("inter-thread communication on the JVM ...")
  // Scala Futures
